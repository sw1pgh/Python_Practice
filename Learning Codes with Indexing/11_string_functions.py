...
print(test_complete_string.count('w'))
...
print(test_complete_string.lstrip())
print(test_complete_string.rstrip())
print(test_complete_string.find('gHoSh'))
print(test_complete_string.replace("swApnaNeeL", "Sw1P"))